...
export interface PresaleInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getAmountStatus",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "previewTokenAmount",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "totalSoldAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Presale extends BaseContract {
  ...
  getAmountStatus: TypedContractMethod<
    [],
    [[bigint, bigint] & { soldAmount: bigint; totalAmount: bigint }],
    "view"
  >;
  ...
  previewTokenAmount: TypedContractMethod<
    [usdtAmount: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  totalSoldAmount: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "getAmountStatus"
  ): TypedContractMethod<
    [],
    [[bigint, bigint] & { soldAmount: bigint; totalAmount: bigint }],
    "view"
  ...
  getFunction(
    nameOrSignature: "previewTokenAmount"
  ...
  >;
  getFunction(
    nameOrSignature: "totalSoldAmount"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
